...
<head>
  ...
  <link rel="stylesheet" href="../css/admin_create-form.css">
  <link rel="icon" href="../imgs/logo.png">
  <script type="module" src="../js/admin_create-form.js" defer></script>
    ...
    <main>
        <div id="new-form-box">
            ...
            <form id="questionnaire-form">
                ...
                <button id="generate-qr-btn" type="button">Generate QR Code</button>
                <div id="qr-code-container"><canvas></canvas></div>
                <button id="download-qr-btn" style="display:none;" type="button">Download QR Code</button>
                <div style="margin: 1rem 0;"></div>
