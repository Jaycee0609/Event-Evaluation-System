...
<head>
    ...
    <link rel="stylesheet" href="../css/organizer_form-analysis.css">
    <link rel="icon" href="../imgs/logo.png">
    <script type="module" src="../js/organizer_form-analysis.js"></script>
</head>
<body>
    <nav id="nav-bar">
    ...
    <main>
        <div id="data-container">
            <a href="/organizer/dash"><img src="../imgs/back.png" alt="" id="back-btn"></a>
            <p id="form-title"></p>
            <p id="form-count"></p>
            <p id="form-pos"></p>
            <p id="form-neg"></p>
