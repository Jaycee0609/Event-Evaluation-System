...
<head>
    ...
    <link rel="stylesheet" href="../css/dept_profile.css">
    <link rel="icon" href="../imgs/logo.png">
    <script type="module" src="../js/dept_profile.js" defer></script>
</head>
<body>
    <nav id="nav-bar">
    ...
    <main>
        <div id="profile-box">
            ...
            <div id="home-btn">
                <img onclick="window.location.href='/dept/dash'" src="../imgs/home-black.png" alt="">
                <p>Home</p>
            </div>
            <div id="logout-btn">
